    ...
    <div class='mx-auto text-center'>
        <div class="border">
            ...
            @foreach($monsters as $monster)
                <div class="border">
                    <li class='flex items-center mt-1 list-none p-4'>
                        <div class="flex justify-between w-full">
                        <p class="capitalize text-left w-[25%]">
                            {{ $monster->id }}
                            </p>
                            <p class="capitalize text-left w-[25%]">
                            {{ $monster->name }}
                        ...
                        <div class='flex gap-2 w-[10rem] justify-end'>
                            <a
                                ...
                                class='py-2 px-3 border border-transparent text-sm font-medium rounded-md text-white bg-gradient-to-r from-indigo-600 to-red-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500' type='button'
                            >
